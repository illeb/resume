...
\address{\href{https://github.com/illeb}{\faGithub*{ illeb}} | \href{https://stackoverflow.com/users/1306679/illeb}{\faStackOverflow{ illeb }} | \href{https://www.linkedin.com/in/stefano-belli/}{\faLinkedinIn{ Stefano Belli}} | \href{mailto://stefano.belli.dev@gmail.com}{\faEnvelope[regular]{ Mail}}}
\address{\faBirthdayCake[regular] 29/01/1993 | \faMapMarker*[regular]{ Borghi (FC), Italy} | \faMobile*{ (+39) 331 5862768}}
...
\begin{rSection}{Interests}
  ...
  In the spare time tries to make something work with Arduinos and Home assistant, with comic results. \\Passionate about mycology, trekking and the usual nerds stuff (d\&d, w40k and mechanical
 keyboards).
\end{rSection}
\end{document}